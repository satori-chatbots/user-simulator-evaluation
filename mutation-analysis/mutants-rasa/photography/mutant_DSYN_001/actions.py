...
media_entity_db={"photography":["photography", "photographs","photo","picture","capture","shot","portraiture"],"video":["video","film","recording","movie","multimedia","cinematography"],"3d rendering":["3d rendering","virtual rendering","3d visualization","3d graphics","digital rendering"],}
...
type_artworks_db={"picture":["picture", "pictures","painting", "paintings","drawing", "drawings","image", "images"],"sculpture":["sculpture", "sculptures","statue", "statues","statuette", "statuettes","sculpted piece","sculpted pieces"],"ceramic":["ceramic","porcelain","pottery","clayware","china", "ceramics","porcelains","potteries","claywares","chinas"],}
...
class WelcomeForm (FormAction):
	...
	def slot_mappings(self):
		return {
		"call_appointment_followUp_name": [self.from_entity(entity="call_appointment_followUp_name"),self.from_text()]}
...
class call_appointment_followUpForm (FormAction):
	...
	def validate_call_appointment_followUp_name(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
		print(value)
	...
	def validate_call_appointment_followUp_phone(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
		print(value)
		parseValue = value
		if parseValue is None:
	...
	def validate_call_appointment_day(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
	...
	def slot_mappings(self):
		return {
		"call_appointment_followUp_name": [self.from_entity(entity="call_appointment_followUp_name"),self.from_text()],
		"call_appointment_followUp_phone": [self.from_entity(entity="call_appointment_followUp_phone"),self.from_text()],
		"call_appointment_followUp_email": [self.from_entity(entity="call_appointment_followUp_email"),self.from_text()],
...
class call_appointment_followUpFormClean (Action):
	...
	def run(self, dispatcher: CollectingDispatcher,
		tracker: Tracker,
		domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
		return [SlotSet("call_appointment_followUp_name", None), SlotSet("call_appointment_followUp_phone", None), SlotSet("call_appointment_day", None), SlotSet("call_appointment_followUp_email", None)]
...
class session_detailsForm (FormAction):
	...
	def validate_session_details_media(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
		print(f"media {value}")
	...
	def validate_session_details_num(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
		print(f"num {value}")
		try:
	...
	def validate_session_details_artwork(self, value: Text,dispatcher: CollectingDispatcher,tracker: Tracker,domain: Dict[Text, Any]) -> Dict[Text, Any]:
